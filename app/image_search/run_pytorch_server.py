...
def classify_process():
    ...
    image_feature_index = em.load_index("embeddings/image_feature_index", 4096)
    image_embeddings, path_map = em.load_features("embeddings/image_features", "embeddings/file_map")
